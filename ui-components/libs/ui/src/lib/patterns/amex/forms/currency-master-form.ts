    ...
    <div class="cumf">
      <div class="cumf__form">
        ...
        <div class="cumf__actions">
          <ui-button
            class="cumf__btn cumf__btn--addnew"
            variant="primary"
            [style.--btn-bg]="
          ...
          <ui-button
            class="cumf__btn cumf__btn--modify"
            variant="primary"
            [style.--btn-bg]="
          ...
          <ui-button
            class="cumf__btn cumf__btn--save"
            variant="primary"
            label="Save"
            (click)="saveClick.emit(form)"
          ></ui-button>
          <ui-button
            class="cumf__btn cumf__btn--cancel"
            variant="secondary"
            label="Cancel"
...
export class AmexCurrencyMasterFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `currency-master-form-${++AmexCurrencyMasterFormComponent._idCounter}`;
