...
@Component({
    ...
    <div class="ppv">
      ...
      <div class="ppv__body">
        ...
        <div class="ppv__search-row">
          ...
          <ui-button
            class="ppv__submit-btn"
            variant="primary"
            label="SUBMIT"
            (click)="search.emit(clientCode)"
          ></ui-button>
        </div>

        <!-- No eligible cards error -->
        <div *ngIf="noEligibleCards" class="ppv__no-cards">
          No eligible cards associated with the client code you entered or the
        ...
        <ng-container *ngIf="!noEligibleCards && cards && cards.length > 0">
          ...
          <div class="ppv__section">
            ...
            <p class="ppv__section-note">
              Please confirm we have the correct contact details for your new
              Priority Pass™.
            </p>
            <p class="ppv__section-warning">
              <strong>Note:</strong> Any updates on your contact details will
              reflect across all our systems including the transaction SMS and
              e-statements.
            </p>
            <div class="ppv__contact-row">
              <span class="ppv__contact-label">Mobile</span>
              <ui-input
                class="ppv__contact-input"
                [ngModel]="mobile"
                [readonly]="true"
              ></ui-input>
              <ui-button
          ...
          <!-- Basic Card dropdown -->
          <div class="ppv__section">
            <div class="ppv__section-title">
              Please select the Basic Card you wish to enroll
            </div>
            <ui-select
              class="ppv__card-select"
              [options]="basicCardOptions"
              [(ngModel)]="selectedBasicCard"
            ></ui-select>
          </div>
          ...
          <div class="ppv__section">
            ...
            <p class="ppv__section-note">
              Please select the Card you wish to enroll
            </p>
            <div *ngFor="let c of cards" class="ppv__card-row">
              <div class="ppv__card-check">
                <ui-checkbox
                  [(ngModel)]="c.selected"
                  [ariaLabel]="'Select ' + c.cardNumber"
                ></ui-checkbox>
              </div>
              ...
              <div class="ppv__card-entitlements">
                <p class="ppv__entitle-intro">
                  As an American Express Corporate Cardmember you are entitled
                  to:
                </p>
                <ui-list class="ppv__entitle-list" [compact]="true">
                  <ui-list-item *ngFor="let e of c.entitlements">{{
                    e
                  }}</ui-list-item>
                </ui-list>
                <div
                  class="ppv__card-status"
          ...
          <div class="ppv__tnc">
            <p class="ppv__tnc-text">
              <strong>To complete your enrolment please confirm that:</strong
              ><br />
              You accept the charges levied by Priority Pass if your Priority
              Pass lounge usage is more than the complimentary allowance on your
              Card.<br />
              You accept the Terms &amp; Conditions of Priority Pass and of the
              American Express Lounge Benefit.<br />
              <em
                >If a customer asks about the terms, they should be redirected
                to the terms online.</em
              >
            </p>
            <ui-checkbox class="ppv__tnc-check" [(ngModel)]="termsAccepted">
              I accept the
              <a class="ppv__tnc-link" href="#">Terms &amp; Conditions</a>
            </ui-checkbox>
          </div>

          <div class="ppv__actions">
            <ui-button
              class="ppv__enroll-btn"
              variant="primary"
              label="CONFIRM &amp; ENROLL"
  ...
  styles: [
    `
      ...
      .ppv__contact-input ::ng-deep .input {
        width: 180px;
        font-size: 12px;
      }
      .ppv__edit-btn {
      ...
      .ppv__card-img ::ng-deep .ui-image-fallback {
        border-radius: 4px;
      }
      ...
      .ppv__card-status--enrolled {
        color: #2e7d32;
      }
      .ppv__card-status--not {
        color: #888;
      }
      ...
      .ppv__enroll-btn ::ng-deep button:disabled {
        background: #aaa;
        opacity: 1;
      }
...
export class AmexPriorityPassViewerComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `priority-pass-viewer-${++AmexPriorityPassViewerComponent._idCounter}`;
