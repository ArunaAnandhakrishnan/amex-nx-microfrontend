  ...
  template: `
    ...
    >
      ...
      <div class="rff__email-check">
        <ui-checkbox
          [id]="id + '-email'"
          [(ngModel)]="form.receiveByEmail"
          label="I would like to receive payment details by email."
        ></ui-checkbox>
      </div>
      ...
      <div class="rff__submit-row">
        <ui-button
          class="rff__btn rff__btn--submit"
          variant="primary"
          label="Submit"
      ...
      <div class="rff__email-section">
        <ui-label class="rff__email-label" [forId]="id + '-new-email'"
          >Add Email Address:</ui-label
        >
        <div class="rff__email-row">
          <ui-input
            [id]="id + '-new-email'"
            class="rff__email-input"
            [(ngModel)]="newEmail"
          ></ui-input>
          <ui-button
            class="rff__btn rff__btn--add"
            variant="secondary"
            label="Add"
            (click)="addEmail()"
          ></ui-button>
        ...
        <div class="rff__email-note">
          Email address(es) registered for receiving payment details via email
          are
        </div>
        <div class="rff__email-list">
          <div
            *ngFor="let e of form.emailAddresses; let i = index"
            class="rff__email-item"
          >
            <span>{{ e }}</span>
...
export class AmexReportFormatFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `report-format-form-${++AmexReportFormatFormComponent._idCounter}`;
  ...
  removeEmail(i: number) {
    this.form.emailAddresses = this.form.emailAddresses.filter(
      (_, idx) => idx !== i,
    );
  }
}
