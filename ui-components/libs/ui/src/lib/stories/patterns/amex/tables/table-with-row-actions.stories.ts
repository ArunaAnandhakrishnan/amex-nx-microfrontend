    ...
    rows: [
      {
        ...
        noOfCharges: '5',
        cardAccountNo: '3714-XXXXXX-12345',
      },
      {
        seNo: '12345002',
        socRefNo: 'SOC-00124',
        ...
        noOfCharges: '8',
        cardAccountNo: '3714-XXXXXX-12346',
      },
      {
        seNo: '12345003',
        socRefNo: 'SOC-00125',
        totalAmount: '430.00',
        noOfCharges: '2',
        cardAccountNo: '3714-XXXXXX-12347',
      },
    ],
    actions: [
...
export const BTAUserManagement: Story = {
  ...
  args: {
    ...
    rows: [
      {
        userId: 'zbaloch301',
        fullName: 'Zaheer Baloch',
        email: 'zaheer.baloch@amex.com.bh',
        status: 'Active',
        country: 'Bahrain',
      },
      {
      ...
      {
        userId: 'khonji1234',
        fullName: 'Abdulrahman Khonji',
        email: 'khonji@amex.com.bh',
        status: 'Active',
        country: 'Bahrain',
      },
    ],
    ...
    rows: [
      {
        ...
        date: '01/10/2024',
        status: 'Completed',
        fileName: 'settlement_oct.csv',
      },
      {
        reportType: 'Rejection Report',
        date: '02/10/2024',
        status: 'Processing',
        fileName: '',
      },
