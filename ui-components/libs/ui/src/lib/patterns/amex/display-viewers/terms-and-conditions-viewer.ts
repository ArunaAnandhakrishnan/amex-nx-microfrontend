    ...
    <div class="tcv">
      ...
      <div class="tcv__scroll" [style.max-height]="maxHeight">
        ...
        <div *ngIf="bullets.length > 0" class="tcv__bullets">
          ...
          <ui-list class="tcv__list" [compact]="true">
            <ui-list-item *ngFor="let b of bullets" class="tcv__list-item">{{
              b
            }}</ui-list-item>
          </ui-list>
        </div>
      ...
      <div class="tcv__accept-row">
        <ui-checkbox
          class="tcv__checkbox"
          [(ngModel)]="accepted"
          (ngModelChange)="acceptedChange.emit(accepted)"
        >
          <span class="tcv__accept-text">
            I accept the
            <span class="tcv__link" (click)="termsLinkClick.emit()"
      ...
      <div class="tcv__actions">
        ...
        <ui-button
          *ngIf="showCancel"
          class="tcv__btn tcv__btn--cancel"
          variant="secondary"
          [label]="cancelLabel"
          (click)="cancel.emit()"
        ></ui-button>
...
export class AmexTermsAndConditionsViewerComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `terms-and-conditions-viewer-${++AmexTermsAndConditionsViewerComponent._idCounter}`;
