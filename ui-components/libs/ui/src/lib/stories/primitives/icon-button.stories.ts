...
export const Ghost: Story = {
  args: { icon: '??', ariaLabel: 'Edit', variant: 'ghost' },
};
export const Primary: Story = {
  args: { icon: '+', ariaLabel: 'Add', variant: 'primary' },
};
export const Danger: Story = {
  args: { icon: '??', ariaLabel: 'Delete', variant: 'danger' },
};
export const Disabled: Story = {
  args: { icon: '??', ariaLabel: 'Edit', disabled: true },
};
