    ...
    <div class="noaf">
      ...
      <div class="noaf__panel">
        <ui-form-field
          class="noaf__field"
          label="Outlet Name"
          [forId]="id + '-outlet-name'"
          [required]="true"
        >
          <ui-input
            [id]="id + '-outlet-name'"
            [(ngModel)]="form.outletName"
        ...
        <div class="noaf__actions">
          <ui-button
            class="noaf__btn noaf__btn--back"
            variant="primary"
            label="Back"
            (click)="backClick.emit()"
          ></ui-button>
          <ui-button
            class="noaf__btn noaf__btn--submit"
            variant="primary"
            label="Submit"
...
export class AmexNewOutletApplicationFormComponent {
  ...
  @HostBinding('attr.id') readonly id =
    `new-outlet-application-form-${++AmexNewOutletApplicationFormComponent._idCounter}`;
  ...
  get businessTypeOptions() {
    return this.businessTypes.map((t) => ({ value: t, label: t }));
  }
}
