...
@Component({
  ...
  styles: [
    `
      ...
      .onls-error__retry-wrap:hover {
        --btn-bg: #c0392b;
        --btn-color: #fff;
      }
      .onls-error__close-wrap {
        --icon-btn-color: #c0392b;
...
export class AmexErrorToastComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `error-toast-${++AmexErrorToastComponent._idCounter}`;
