    ...
    >
      ...
      <div class="visf__toggle-row">
        ...
        <ui-button
          ...
          variant="secondary"
          label="Consumer"
          (click)="form.customerType = 'consumer'"
        ></ui-button>
      </div>
      ...
      <div class="visf__mode-tabs">
        ...
        <ui-button
          ...
          variant="secondary"
          label="Invoice No"
          (click)="form.searchMode = 'invoiceNo'"
        ></ui-button>
        <ui-button
          class="visf__mode-tab"
          ...
          (click)="form.searchMode = 'basicControl'"
        ></ui-button>
      </div>
      ...
      <div class="visf__actions">
        <ui-button
          class="visf__btn visf__btn--back"
          variant="primary"
          label="Back"
          (click)="backClick.emit()"
        ></ui-button>
        <ui-button
          class="visf__btn visf__btn--submit"
          variant="primary"
          label="Submit"
...
export class AmexVATInvoiceSearchFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `vat-invoice-search-form-${++AmexVATInvoiceSearchFormComponent._idCounter}`;

  form: VATInvoiceSearchData = {
  ...
  get inputLabel(): string {
    return {
      ...
      basicControl: 'Basic Control Account',
    }[this.form.searchMode];
  }
  get inputPlaceholder(): string {
    return {
      vatReg: 'Enter VAT Registration Number',
      invoiceNo: 'Enter Invoice Number',
      basicControl: 'Enter Basic Control Account',
    }[this.form.searchMode];
  }
