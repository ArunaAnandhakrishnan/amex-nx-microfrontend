...
@Component({
    ...
    <div class="mstv">
      ...
      <div class="mstv__body">
        ...
        <div class="mstv__center">
          ...
          <div class="mstv__agent">
            Travel Agent: {{ travelAgent }} - Telephone: {{ telephone }}
          </div>
        </div>
          ...
          <ui-table class="mstv__summary" [bordered]="true">
            <ui-table-head>
              <ui-table-row [header]="true">
                <ui-table-header-cell align="center"
                  >Previous Balance</ui-table-header-cell
                >
                <ui-table-header-cell align="center"
                  >New Remittance</ui-table-header-cell
                >
                <ui-table-header-cell align="center"
                  >New Credit</ui-table-header-cell
                >
                <ui-table-header-cell align="center"
                  >New Debits</ui-table-header-cell
                >
                <ui-table-header-cell align="center"
                  >Disputes*</ui-table-header-cell
                >
                <ui-table-header-cell align="center"
                  >Total Due Balance</ui-table-header-cell
                >
              </ui-table-row>
            </ui-table-head>
            <ui-table-body>
              <ui-table-row [hoverable]="false">
                <ui-table-cell
                  align="center"
                  [class.mstv__neg]="summary.previousBalance < 0"
                  >{{
                    summary.previousBalance | number: '1.3-3'
                  }}</ui-table-cell
                >
                <ui-table-cell align="center">{{
                  summary.newRemittance | number: '1.3-3'
                }}</ui-table-cell>
                <ui-table-cell align="center">{{
                  summary.newCredit | number: '1.3-3'
                }}</ui-table-cell>
                <ui-table-cell align="center">{{
                  summary.newDebits | number: '1.3-3'
                }}</ui-table-cell>
                <ui-table-cell align="center" [class.mstv__blue]="true">{{
                  summary.disputes | number: '1.3-3'
                }}</ui-table-cell>
                <ui-table-cell
                  align="center"
                  [class.mstv__neg]="summary.totalDueBalance < 0"
                  >{{
                    summary.totalDueBalance | number: '1.3-3'
                  }}</ui-table-cell
                >
              </ui-table-row>
              <ui-table-row [hoverable]="false">
                <ui-table-cell [colspan]="4"></ui-table-cell>
                <ui-table-cell [colspan]="2" class="mstv__due-date"
                  >Total Balance Due by
                  {{ summary.totalDueDate }}</ui-table-cell
                >
              </ui-table-row>
            </ui-table-body>
          </ui-table>
        ...
        <div
          *ngIf="transactions && transactions.length > 0; else noTxn"
          class="mstv__table-wrap"
        >
          <ui-table class="mstv__txn-table" [bordered]="true">
            <ui-table-head>
              <ui-table-row [header]="true">
                ...
                <ui-table-header-cell align="right"
        ...
        <!-- Legend -->
        <div class="mstv__legend">1 Remittance - 2 Refund - 3 Dispute</div>
      ...
      <div class="mstv__footer">
        <div class="mstv__footer-left">
          <ui-label
            class="mstv__view-label"
            [forId]="id + '-view-a-different-montly-statement'"
            >View a Different Montly Statement:</ui-label
          >
          <ui-select
            [id]="id + '-view-a-different-montly-statement'"
            class="mstv__month-select"
            [options]="availableMonthOptions"
            [(ngModel)]="selectedMonth"
          ></ui-select>
          <ui-button
            class="mstv__show-btn"
            variant="secondary"
            label="Show Statement"
            (click)="showStatement.emit(selectedMonth)"
          ></ui-button>
        </div>
        <div class="mstv__footer-right">
          <ui-select
            class="mstv__fmt-select"
          ...
          <ui-button
            ...
            (click)="download.emit(selectedFormat)"
          ></ui-button>
        </div>
      </div>
      <div class="mstv__footer-back">
        <ui-button
          class="mstv__back-btn"
          variant="secondary"
          label="Return to Account Selection"
  ...
  styles: [
    `
      ...
      .mstv__summary ::ng-deep .ui-table {
        font-size: 12px;
      }
      .mstv__neg {
        color: #c00;
      ...
      .mstv__txn-table ::ng-deep .ui-table {
        font-size: 12px;
      }
      .mstv__row-alt ::ng-deep .ui-td {
        background: #f0f8ff;
      }
...
export class AmexMonthlyStatementViewerComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `monthly-statement-viewer-${++AmexMonthlyStatementViewerComponent._idCounter}`;
  ...
  get availableMonthOptions(): SelectOption[] {
    return this.availableMonths.map((m) => ({ value: m, label: m }));
  }
