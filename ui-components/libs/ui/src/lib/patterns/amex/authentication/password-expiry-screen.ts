      ...
      <div class="header">
        ...
        <div class="portal-title-wrap">
          <span class="portal-name">{{
            portalTitle || 'Business Travel Accounts'
          }}</span>
        </div>
      </div>
        ...
        <div class="main-content">
          <div class="panel">
            ...
            <div class="expiry-notice">
              <strong>Your password has expired.</strong> Please set a new
            ...
            <p class="required-note">
              All fields marked <span class="req">*</span> are mandatory
            </p>
            ...
            <ui-form-field
              ...
              [required]="true"
              [forId]="id + '-confirm-new-password'"
            >
              <ui-input
                class="field-input"
                [id]="id + '-confirm-new-password'"
                type="password"
                [required]="true"
...
export class AmexPasswordExpiryScreenComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `password-expiry-screen-${++AmexPasswordExpiryScreenComponent._idCounter}`;
