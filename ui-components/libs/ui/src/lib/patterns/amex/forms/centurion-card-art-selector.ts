  ...
  template: `
    <div class="ccas">
      ...
      <div class="ccas__wearable-opt">
        <ui-checkbox
          [(ngModel)]="includeWearable"
          label="Include Wearable product with this card issuance"
        ></ui-checkbox>
      </div>
      <div class="ccas__actions">
        <ui-button
          class="ccas__btn ccas__btn--back"
          variant="primary"
          label="Back"
          (click)="backClick.emit()"
        ></ui-button>
        <ui-button
          class="ccas__btn ccas__btn--confirm"
          variant="primary"
...
export class AmexCenturionCardArtSelectorComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `centurion-card-art-selector-${++AmexCenturionCardArtSelectorComponent._idCounter}`;
