  ...
  template: `
    ...
    >
      ...
      <div class="content-wrapper">
        ...
        <div class="main-content">
          ...
          <div class="panel-onls" *ngIf="portalStyle === 'onls'">
            <div class="success-box" *ngIf="success && !errorMessage">
            ...
            <div class="back-link" *ngIf="success && !errorMessage">
              <a class="form-link" (click)="backToLogin.emit()" tabindex="0">
                Back to Login
              </a>
            </div>
          </div>
      ...
      <div class="footer-links" *ngIf="portalStyle === 'onls'">
        ...
        <a class="footer-link" href="#"> News Centre </a>

        |

        <a class="footer-link" href="#"> Fraud Protection Centre </a>

        |

        <a class="footer-link" href="#"> Trademarks </a>
...
export class AmexForgotPasswordFormComponent implements AfterViewChecked {
  ...
  @HostBinding('attr.id') @Input() id =
    `forgot-password-form-${++AmexForgotPasswordFormComponent._idCounter}`;
