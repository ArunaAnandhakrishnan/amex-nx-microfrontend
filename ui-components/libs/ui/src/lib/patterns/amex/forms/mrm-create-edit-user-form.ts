    ...
    <ui-accent-card class="mrm" [accentColor]="'#7b1fa2'" [maxWidth]="'480px'">
      ...
      <ui-form-field class="mrm__field" label="Merchant Access">
        <div class="mrm__access-list">
          <ui-checkbox
            *ngFor="let m of merchantOptions"
            [label]="m.label"
      ...
      <div class="mrm__actions">
        <ui-button
          class="mrm__btn mrm__btn--back"
          variant="primary"
          label="Back"
          (click)="backClick.emit()"
        ></ui-button>
        <ui-button
          class="mrm__btn mrm__btn--save"
          variant="primary"
          label="Save"
...
export class AmexMRMCreateEditUserFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `mrm-create-edit-user-form-${++AmexMRMCreateEditUserFormComponent._idCounter}`;
