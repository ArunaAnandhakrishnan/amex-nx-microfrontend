    ...
    <div class="apf">
      <fieldset class="apf__fieldset">
        ...
        <div class="apf__actions">
          <ui-button
            class="apf__btn apf__btn--view"
            variant="secondary"
            label="View Report"
            (click)="viewReport.emit(form)"
          ></ui-button>
        </div>
      </fieldset>
    </div>
...
export class AmexAlgeriaPaymentFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `algeria-payment-form-${++AmexAlgeriaPaymentFormComponent._idCounter}`;

  @Input() years = ['2024', '2023', '2022', '2021'];
  form: AlgeriaPaymentData = {
    julianDay: '',
    year: '2024',
    exchangeRate: '1',
    referenceNo: '1',
