          ...
          <div class="main-content">
            <div class="panel">
              ...
              <ng-container *ngIf="!submitted || errorMessage">
                <p class="help-text">
                  Please enter your registered email address. Your User ID will
              ...
              <div class="back-link" *ngIf="submitted && !errorMessage">
                <a class="form-link" (click)="backToLogin.emit()">
                  Back to Login
                </a>
              </div>
            </div>
...
export class AmexForgotUserIdFormComponent implements AfterViewChecked {
  ...
  ngAfterViewChecked(): void {
    if (this.portalStyle !== 'oms' || this.autofocusedStyle === 'oms') {
      return;
    }
  ...
  onSubmitOms(): void {
    if (!this.email.trim() || !this.merchantNumber.trim()) {
      this.errorMessage = 'Email Address and Merchant Number are required.';
      return;
    }
  ...
  handleGlobalKeydown(event: KeyboardEvent): void {
    if (event.key === 'Escape' && this.portalStyle === 'oms') {
      this.emailInputOms?.focus();
    }
  }
}
