...
export const Credit: Story = {
  args: {
    transaction: {
      date: '08 Mar 2024',
      description: 'Refund — Emirates Airlines',
      referenceNumber: 'REF-00190011',
      amount: 1200.0,
      currency: 'AED',
      type: 'credit',
      category: 'Travel',
...
export const WithStatus: Story = {
  args: {
    transaction: {
      date: '05 Mar 2024',
      description: 'Hotel Atlantis — Dispute',
      referenceNumber: 'REF-00185544',
      amount: 5400.0,
      currency: 'AED',
      type: 'debit',
      status: 'pending',
