...
const rows = [
  {
    userId: 'mrmadmin',
    userName: 'Essa',
    emailAddress: 'essa.memon@americanexpress.com.bh',
  ...
  {
    userId: 'mrmadmintest4',
    userName: 'mrmadminketaki',
    emailAddress: 'ketaki_pore@yahoo.com',
    creationDate: '09/09/2021',
    status: 'Active',
  },
  {
    userId: 'ketakimrm12',
    userName: 'Ketaki',
    emailAddress: 'ketaki.pore222@gmail.com',
...
export const MRMAdmin: Story = {
  args: {
    rows,
    title: 'MRM USER ADMINISTRATION',
    createLabel: 'Create MRM User',
    showDelete: true,
  },
};
export const OMSUsers: Story = {
  args: {
    rows,
    title: 'OMS USER ADMINISTRATION',
    createLabel: 'Create OMS User',
    showDelete: false,
  },
};
