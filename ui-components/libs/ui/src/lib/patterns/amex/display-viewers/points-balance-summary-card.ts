  ...
  template: `
    <div class="pbsc">
      ...
      <div class="pbsc__tabs">
        ...
        ></ui-button>
        <ui-button
          class="pbsc__tab pbsc__tab--grey"
      ...
      <div class="pbsc__selector-row">
        <ui-label class="pbsc__selector-label" [forId]="id + '-select-a-card'"
          >Select a Card</ui-label
        >
        <ui-select
          [id]="id + '-select-a-card'"
          class="pbsc__card-select"
          [options]="cardOptions"
          placeholder="-- Select --"
          [(ngModel)]="selectedCardNumber"
          (ngModelChange)="cardSelected.emit(selectedCardNumber)"
        ></ui-select>
        <ui-image
          *ngIf="selectedCardNumber"
          class="pbsc__card-img"
      ...
      <div
        *ngIf="selectedCardNumber && !errorMessage && balance !== null"
        class="pbsc__balance"
      >
...
export class AmexPointsBalanceSummaryCardComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `points-balance-summary-card-${++AmexPointsBalanceSummaryCardComponent._idCounter}`;
