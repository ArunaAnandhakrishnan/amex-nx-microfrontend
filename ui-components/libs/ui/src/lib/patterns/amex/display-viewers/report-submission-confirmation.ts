...
@Component({
    ...
    <div class="rsc">
      ...
      <div *ngIf="variant === 'bcrb'" class="rsc__bcrb">
        <div class="rsc__bcrb-header">
          ...
          <span class="rsc__bcrb-user" *ngIf="username"
            >User :- {{ username }}</span
          >
        </div>
        <div class="rsc__bcrb-body">
          ...
          <div class="rsc__bcrb-links">
            <span class="rsc__link" (click)="requestNew.emit()"
              >Request New Report +</span
            >
            <span class="rsc__link rsc__link--right" (click)="refresh.emit()"
          ...
          <div class="rsc__bcrb-details" *ngIf="requestId || referenceNo">
            ...
            <div *ngIf="status" class="rsc__detail-row">
              ...
              <span
                class="rsc__detail-value"
                [class.rsc__status--error]="isError"
                >{{ status }}</span
              >
            </div>
          </div>
      ...
      <div *ngIf="variant !== 'bcrb'" class="rsc__generic">
        ...
        <div class="rsc__generic-content">
          ...
          <div *ngIf="status" class="rsc__detail-row">
            ...
            <span class="rsc__detail-value rsc__status--badge">{{
              status
            }}</span>
          </div>
        </div>
        <div class="rsc__generic-actions">
          <ui-button
            ...
            variant="secondary"
            [label]="newRequestLabel || 'New Request'"
  ...
  styles: [
    `
      ...
      .rsc__generic-message {
        font-size: 13px;
        color: #2e7d32;
        margin-bottom: 8px;
      }
      .rsc__generic-actions {
        display: flex;
...
export class AmexReportSubmissionConfirmationComponent {
  ...
  @HostBinding('attr.id') readonly id =
    `report-submission-confirmation-${++AmexReportSubmissionConfirmationComponent._idCounter}`;
