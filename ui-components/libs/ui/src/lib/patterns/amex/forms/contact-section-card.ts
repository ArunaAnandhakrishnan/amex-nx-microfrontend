    ...
    >
      <div
        *ngFor="let contact of contacts; let i = index"
        class="csc__contact-row"
      >
        <ui-input
          class="csc__input csc__input--full"
        ...
        <div class="csc__contact-bottom">
          <ui-input
            class="csc__input csc__input--email"
          ...
          <ui-select
            class="csc__select csc__select--country"
          ...
          <ui-input
            class="csc__input csc__input--phone"
...
export class ContactSectionCardComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `contact-section-card-${++ContactSectionCardComponent._idCounter}`;
