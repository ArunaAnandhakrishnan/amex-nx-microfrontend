      ...
      <div class="msv__body">
        ...
        <div
          *ngIf="transactions && transactions.length > 0; else noTxn"
          class="msv__table-wrap"
        >
          <ui-table class="msv__table">
            <ui-table-head>
              <ui-table-row [header]="true" [hoverable]="false">
                <ui-table-header-cell class="msv__th"
                  >Type</ui-table-header-cell
                >
                <ui-table-header-cell class="msv__th"
                ...
                >
                <ui-table-header-cell class="msv__th msv__th-num" align="right"
            ...
            <ui-table-body>
              <ui-table-row
                *ngFor="let tx of transactions; let i = index"
                [hoverable]="false"
                [class.msv__row-alt]="i % 2 === 1"
              >
                <ui-table-cell class="msv__td">{{ tx.type }}</ui-table-cell>
                <ui-table-cell class="msv__td">{{ tx.date }}</ui-table-cell>
                <ui-table-cell class="msv__td">{{
                  tx.description
                }}</ui-table-cell>
                <ui-table-cell class="msv__td msv__td-num" align="right">{{
        ...
        <div class="msv__legend">
          1 Remittance - 2 Refund - 3 Dispute - 5 Allocated - 6 Allocated &amp;
          Paid
        </div>
        <div class="msv__note">
          Should you have any enquiry regarding the transactions and information
          displayed, kindly contact your Travel Agent or AEME BTA Team on (+973)
          17 557243.
        </div>
      </div>
...
export class AmexMemoStatementViewerComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `memo-statement-viewer-${++AmexMemoStatementViewerComponent._idCounter}`;
