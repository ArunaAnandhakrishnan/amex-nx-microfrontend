    ...
    <div class="atsv">
      ...
      <div class="atsv__panel">
        ...
        <div class="atsv__tabs">
          <ui-button
            class="atsv__tab"
            [class.atsv__tab--active]="activeTab === 'detail'"
            variant="secondary"
          ...
          <ui-button
            class="atsv__tab"
            [class.atsv__tab--active]="activeTab === 'summary'"
            variant="secondary"
        ...
        <div *ngIf="showResults" class="atsv__results">
          <div class="atsv__result-info">
            ...
            <div class="atsv__info-line" *ngIf="corporationName">
              Corporation Name:
              <span class="atsv__corp-name">{{ corporationName }}</span>
            </div>
          ...
          <div
            *ngIf="
              !noEntries && activeTab === 'detail' && detailEntries.length > 0
            "
          ...
          >
            <ui-table class="atsv__table" [bordered]="true">
              ...
              <ui-table-body>
                <ui-table-row
                  *ngFor="let e of detailEntries; let i = index"
          ...
          <div
            *ngIf="
              !noEntries && activeTab === 'summary' && summaryEntries.length > 0
            "
            class="atsv__table-wrap"
          >
            <ui-table class="atsv__table" [bordered]="true">
              ...
              <ui-table-body>
                <ui-table-row
                  *ngFor="let e of summaryEntries; let i = index"
                  [class.atsv__row-alt]="i % 2 === 1"
                  [hoverable]="false"
                >
                  <ui-table-cell>{{ e.user }}</ui-table-cell>
          ...
          <div class="atsv__download-row">
            ...
            <ui-button
              ...
              (click)="download.emit(downloadFormat)"
            ></ui-button>
          </div>
        </div>
      </div>
  ...
  styles: [
    `
      ...
      .atsv__tab {
        --btn-bg: #e8f4fb;
        --btn-color: #333;
        --btn-border: 1px solid #a8c8e0;
        --btn-border-bottom-color: #a8c8e0;
        --btn-radius: 0px;
      ...
      .atsv__table ::ng-deep .ui-table {
        font-size: 11px;
      }
      .atsv__row-alt ::ng-deep .ui-td {
        background: #f0f7ff;
      }
      .atsv__download-row {
        display: flex;
...
export class AmexAuditTrailSummaryViewComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `audit-trail-summary-view-${++AmexAuditTrailSummaryViewComponent._idCounter}`;
  ...
  @Output() showTrail = new EventEmitter<{
    year: string;
    month: string;
    tab: string;
  }>();
  ...
  get yearOptions(): SelectOption[] {
    return this.years.map((y) => ({ value: y, label: y }));
  }
  get monthOptions(): SelectOption[] {
    return this.months.map((m) => ({ value: m, label: m }));
  }
  get downloadFormatOptions(): SelectOption[] {
    return this.downloadFormats.map((f) => ({ value: f, label: f }));
  }
