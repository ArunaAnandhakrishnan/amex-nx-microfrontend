...
const meta: Meta<AmexUploadCertificatePanelComponent> = {
  title: 'Patterns/Amex/Forms/UploadCertificatePanel',
  component: AmexUploadCertificatePanelComponent,
  tags: ['autodocs'],
  argTypes: {
    title: { control: 'text' },
...
export const Idle: Story = {
  ...
  args: { status: 'idle', hintText: 'Please upload only .pdf or .jpg files' },
};
export const Success: Story = {
  name: 'Upload success',
  args: {
    status: 'success',
    statusMessage: 'Certificate uploaded successfully.',
  },
};
