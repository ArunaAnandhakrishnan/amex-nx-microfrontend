      ...
      <ui-table class="prt__table" [bordered]="true">
        ...
        <ui-table-body>
          ...
          <ui-table-row *ngIf="!rows.length" [hoverable]="false">
            <ui-table-cell [colspan]="5" [align]="'center'" class="prt__empty"
...
export class AmexPaymentRegisterTableComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `payment-register-table-${++AmexPaymentRegisterTableComponent._idCounter}`;
