...
const meta: Meta<AmexOffersPanelComponent> = {
  ...
  decorators: [
    (story) => ({
      ...story(),
      template: `<div style="width:900px;padding:0">${story().template}</div>`,
    }),
  ],
};
export default meta;
...
const sampleOffers = [
  ...
  },
  {
    ...
    description: 'Special save-to-card promotional offer',
    category: 'promo',
    expiryDate: '25 Dec, 2027',
    hasFlash: true,
  },
  {
    ...
    description: '10% cashback at all partner restaurants',
    category: 'dining',
