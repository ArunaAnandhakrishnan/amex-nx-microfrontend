...
export const Debit: Story = {
  args: { amount: 1250.75, currency: 'AED', type: 'debit' },
};
export const Credit: Story = {
  args: { amount: 500.0, currency: 'AED', type: 'credit' },
};
export const Neutral: Story = {
  args: { amount: 3400.0, currency: 'AED', type: 'neutral' },
};
export const USD: Story = {
  args: { amount: 89.99, currency: 'USD', type: 'debit' },
};
