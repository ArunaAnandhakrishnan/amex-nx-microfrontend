    ...
    <div class="usrf">
      ...
      <div *ngIf="activeTab === 'request'" class="usrf__form">
        <ui-form-field
          class="usrf__field"
          label="Emirates ID"
          [forId]="id + '-emirates-id'"
        >
          <ui-input
            [id]="id + '-emirates-id'"
            [(ngModel)]="form.emiratesId"
            placeholder="e.g. 784199900001200"
          ></ui-input>
        </ui-form-field>
        <ui-form-field
          class="usrf__field"
          label="IBAN Number"
          [forId]="id + '-iban-number'"
        >
          <ui-input
            [id]="id + '-iban-number'"
            [(ngModel)]="form.ibanNumber"
        ...
        <ui-form-field
          ...
          [forId]="id + '-statement-period'"
        >
          <ui-select
            [id]="id + '-statement-period'"
            [options]="statementPeriodOptions"
            [(ngModel)]="form.statementPeriod"
          ></ui-select>
        </ui-form-field>
        <ui-form-field
          class="usrf__field"
          label="Customer Consent"
          [forId]="id + '-customer-consent'"
        >
          <ui-input
            [id]="id + '-customer-consent'"
            [(ngModel)]="form.customerConsent"
            placeholder="dd/mm/yyyy"
          ></ui-input>
        </ui-form-field>
        <div class="usrf__actions">
          <ui-button
            class="usrf__btn usrf__btn--submit"
            variant="primary"
            [fullWidth]="true"
            label="Submit"
      ...
      <div *ngIf="successData" class="usrf__success-overlay">
        <div class="usrf__success-modal">
          ...
          <ui-button
            class="usrf__btn usrf__btn--back"
            variant="primary"
            [fullWidth]="true"
            label="Back"
...
export class AmexUAEFTSStatementRequestFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `uaefts-statement-request-form-${++AmexUAEFTSStatementRequestFormComponent._idCounter}`;

  @Input() successData: UAEFTSSuccessData | null = null;

  activeTab: 'search' | 'request' = 'request';
  form: UAEFTSRequestData = {
    emiratesId: '',
    ibanNumber: '',
    statementPeriod: '3',
    customerConsent: '',
