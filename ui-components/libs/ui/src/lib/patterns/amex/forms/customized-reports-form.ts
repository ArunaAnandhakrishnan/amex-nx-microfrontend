  ...
  template: `
    ...
    >
      ...
      <div class="crf__sub-row">
        <ui-checkbox
          [(ngModel)]="form.emailSubscription"
          label="Subscribe to email notifications for this report"
        ></ui-checkbox>
      </div>

      <div class="crf__actions">
        <ui-button
          class="crf__btn crf__btn--back"
          variant="primary"
          label="Back"
          (click)="backClick.emit()"
        ></ui-button>
        <ui-button
          class="crf__btn crf__btn--submit"
          variant="primary"
          label="Submit"
...
export class AmexCustomizedReportsFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `customized-reports-form-${++AmexCustomizedReportsFormComponent._idCounter}`;
