...
@Component({
  ...
  template: `
    <div class="portal-shell">
      ...
      <div class="portal-strip">
        ...
        <ui-button
          [id]="id + '-logout'"
          class="portal-strip__logout-wrap"
          label="Log Out"
          size="sm"
          variant="ghost"
          (click)="logout.emit()"
      ...
      <div class="portal-footer">
        ...
        <span class="portal-footer__copy"
  ...
  styles: [
    `
      ...
      .portal-strip__logout-wrap:hover {
        --btn-bg: #e0e0e0;
      }
      .portal-header {
        background: #fff;
...
export class AmexPortalHomeTilesComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `portal-home-tiles-${++AmexPortalHomeTilesComponent._idCounter}`;
