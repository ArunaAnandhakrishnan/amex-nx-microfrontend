  ...
  template: `
    ...
    >
      ...
      <div class="ucp__actions">
        <ui-button
          class="ucp__btn ucp__btn--back"
          variant="primary"
          label="Back"
          (click)="backClick.emit()"
        ></ui-button>
        <ui-button
          class="ucp__btn ucp__btn--upload"
          variant="primary"
          [label]="uploadLabel"
          [disabled]="!selectedFile"
          (click)="uploadClick.emit(selectedFile)"
        ></ui-button>
      </div>
    </ui-accent-card>
  `,
...
export class AmexUploadCertificatePanelComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `upload-certificate-panel-${++AmexUploadCertificatePanelComponent._idCounter}`;
