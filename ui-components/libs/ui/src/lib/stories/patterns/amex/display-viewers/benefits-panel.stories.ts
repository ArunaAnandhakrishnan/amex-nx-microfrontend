...
const meta: Meta<AmexBenefitsPanelComponent> = {
  ...
  decorators: [
    (story) => ({
      ...story(),
      template: `<div style="width:900px">${story().template}</div>`,
    }),
  ],
};
export default meta;
  ...
  args: {
    benefits: [
      ...
      },
      {
        ...
        description: 'Complimentary lounge access at 1300+ airports',
        category: 'travel',
        validFrom: '01 Jan 2025',
        validUntil: '31 Dec 2025',
        hasFlash: false,
        enrolled: true,
        termsAndConditions:
          'Valid for primary card member only. Guest charges apply.',
        imageUrl:
          'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=400&auto=format&fit=crop',
      },
      {
        id: '3',
        title: 'Hotel Status Upgrade',
        description: 'Guaranteed room upgrade at Marriott & Hilton',
        category: 'travel',
        validFrom: '01 Mar 2025',
