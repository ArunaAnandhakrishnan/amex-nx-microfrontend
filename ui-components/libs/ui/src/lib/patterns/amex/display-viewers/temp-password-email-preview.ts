        ...
        <ui-table class="tpep__meta">
          <ui-table-body>
            <ui-table-row [hoverable]="false">
              ...
              <ui-table-cell class="tpep__meta-value">{{
                fromAddress
              }}</ui-table-cell>
            </ui-table-row>
            <ui-table-row [hoverable]="false">
        ...
        <div class="tpep__body">
          ...
          <div class="tpep__creds">
            ...
            <div class="tpep__cred-row">
              ...
              <span class="tpep__cred-value tpep__cred-value--pw">{{
                tempPassword
              }}</span>
            </div>
          </div>
          ...
          <p class="tpep__text">
            ...
            <a class="tpep__link" [href]="portalUrl" target="_blank">{{
              portalUrl
            }}</a>
          </p>
          <p class="tpep__text tpep__text--small">
            If you did not request this, please contact your system
...
export class AmexTempPasswordEmailPreviewComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `temp-password-email-preview-${++AmexTempPasswordEmailPreviewComponent._idCounter}`;
