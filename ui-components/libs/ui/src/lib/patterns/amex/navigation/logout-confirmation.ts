    ...
    <div *ngIf="visible" class="overlay" (click)="onOverlay($event)">
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        <div class="dialog__actions">
          <ui-button
            [id]="id + '-ok'"
            class="dialog__btn-wrap dialog__btn-wrap--ok"
            label="OK"
            size="sm"
            (click)="confirm.emit()"
          >
          ...
          <ui-button
            [id]="id + '-cancel'"
            class="dialog__btn-wrap dialog__btn-wrap--cancel"
            label="Cancel"
            size="sm"
            (click)="cancel.emit()"
          >
...
export class AmexLogoutConfirmationComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `logout-confirmation-${++AmexLogoutConfirmationComponent._idCounter}`;
