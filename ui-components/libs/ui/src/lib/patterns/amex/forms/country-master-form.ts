    ...
    <div class="cmf">
      <div class="cmf__form">
        ...
        <ui-form-field
          ...
          labelWidth="130px"
          label="Country Name"
          [required]="form.action === 'addNew'"
          [forId]="id + '-country-name'"
        >
          <ui-input
        ...
        <div class="cmf__actions">
          <ui-button
            class="cmf__btn cmf__btn--addnew"
            variant="primary"
            [style.--btn-bg]="
              form.action === 'addNew' ? activeGradient : defaultGradient
            "
            [style.--btn-border]="
              form.action === 'addNew'
                ? '1px solid #002a6a'
          ...
          <ui-button
            class="cmf__btn cmf__btn--modify"
            variant="primary"
            [style.--btn-bg]="
              form.action === 'modify' ? activeGradient : defaultGradient
            "
            [style.--btn-border]="
              form.action === 'modify'
                ? '1px solid #002a6a'
          ...
          <ui-button
            class="cmf__btn cmf__btn--save"
            variant="primary"
            label="Save"
            (click)="saveClick.emit(form)"
          ></ui-button>
          <ui-button
            class="cmf__btn cmf__btn--cancel"
            variant="secondary"
            label="Cancel"
...
export class AmexCountryMasterFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `country-master-form-${++AmexCountryMasterFormComponent._idCounter}`;
