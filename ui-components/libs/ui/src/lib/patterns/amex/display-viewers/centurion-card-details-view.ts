  ...
  template: `
    <div class="ccdv">
      ...
      <div class="ccdv__search">
        ...
        <ui-button
          class="ccdv__submit-btn"
          variant="secondary"
          label="Submit"
          (click)="search.emit(clientIdInput)"
        ></ui-button>
      </div>
          ...
          <ui-table class="ccdv__table">
            <ui-table-body>
              ...
              <ui-table-row
                [hoverable]="false"
                class="ccdv__row"
                *ngIf="details.cardType"
              >
                <ui-table-cell
                  width="150px"
                  verticalAlign="top"
                  class="ccdv__td-label"
                  >Card Type</ui-table-cell
                >
                <ui-table-cell verticalAlign="top" class="ccdv__td-value">{{
                  details.cardType
                }}</ui-table-cell>
              ...
              >
                <ui-table-cell
                  ...
                  verticalAlign="top"
                  class="ccdv__td-label"
                  >Status</ui-table-cell
                >
                <ui-table-cell verticalAlign="top" class="ccdv__td-value">
                  <span
                    [class.ccdv__status--active]="details.status === 'Active'"
              ...
              <ui-table-row
                [hoverable]="false"
                class="ccdv__row"
                *ngIf="details.issuanceState"
              >
                <ui-table-cell
                  width="150px"
                  verticalAlign="top"
                  class="ccdv__td-label"
                  >Issuance State</ui-table-cell
                >
                <ui-table-cell verticalAlign="top" class="ccdv__td-value">{{
              ...
              <ui-table-row
                [hoverable]="false"
                class="ccdv__row"
                *ngIf="details.premiumizationStatus"
              >
                <ui-table-cell
                  width="150px"
                  verticalAlign="top"
                  class="ccdv__td-label"
                  >Premiumization</ui-table-cell
                >
                <ui-table-cell verticalAlign="top" class="ccdv__td-value">{{
                  details.premiumizationStatus
                }}</ui-table-cell>
              </ui-table-row>
            </ui-table-body>
          </ui-table>
      ...
      <!-- Highlights -->
      <div
        *ngIf="details && details.highlights && details.highlights.length > 0"
        class="ccdv__highlights"
      >
        <h3 class="ccdv__highlights-title">Highlights</h3>
        <ui-list class="ccdv__highlights-list">
          <ui-list-item
            *ngFor="let h of details.highlights"
            class="ccdv__highlight-item"
          >
...
export class AmexCenturionCardDetailsViewComponent {
  ...
  @HostBinding('attr.id') readonly id =
    `centurion-card-details-view-${++AmexCenturionCardDetailsViewComponent._idCounter}`;
