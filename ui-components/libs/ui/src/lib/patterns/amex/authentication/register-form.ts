    ...
    >
      ...
      <ng-container *ngIf="portalStyle === 'oms'">
        <div class="oms-wrapper" [style.width]="cardMaxWidth">
          <div class="error-box" *ngIf="errorMessage">{{ errorMessage }}</div>
          <div class="oms-success-card" *ngIf="successMessage">
            <div class="oms-success-message">
              {{ successMessage }}
            </div>

            <div class="oms-success-button">
              <ui-button variant="primary" label="Ok" (click)="cancel.emit()">
              </ui-button>
            </div>
          </div>
          ...
          <div
            class="oms-card"
            *ngIf="!successMessage"
            [style.borderTopColor]="cardAccentColor"
          >
            <ui-input
              class="field-oms"
...
export class AmexRegisterFormComponent {
  ...
  @HostBinding('attr.id') @Input() id =
    `register-form-${++AmexRegisterFormComponent._idCounter}`;
