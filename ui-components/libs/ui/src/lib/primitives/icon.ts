...
@Component({
  ...
  template: `
    ...
    >
      ...
      <span *ngIf="!hasProjectedContent" class="ui-icon-glyph">{{
        glyph
      }}</span>
    </span>
  `,
...
export class IconComponent implements AfterContentInit {
  ...
  @ViewChild('projectedSlot', { static: true })
  projectedSlot!: ElementRef<HTMLElement>;
  ...
  ngAfterContentInit(): void {
    this.hasProjectedContent =
      this.projectedSlot.nativeElement.childNodes.length > 0;
  }
}
